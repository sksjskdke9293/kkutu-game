# 끄투게임 (KKuTu Game)
- 이 프로젝트의 프로그램 코드는 **GPL-3.0-or-later**로 배포됩니다.
- 기반 프로젝트: [JJoriping/KKuTu](https://github.com/JJoriping/KKuTu)
- 게임 이미지·음원 등 자산의 고지는 [ASSET-LICENSE.md](ASSET-LICENSE.md)를 확인하세요.
